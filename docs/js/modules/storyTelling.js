...
import tpl_storytelling from "../template/storyTelling.js";
...
export const storyTelling = () => {
	...
	const renderDinamicBattery = () => {
		eventBattery({
			chargingStatus: (value) => {
				...
				console.log(value);
				document.querySelector(".js-charging").innerHTML = obj.battery.charging;
			},
			percentCharged: (value) => {
				obj.battery.percentCharged = value + "%";
				window.your.battery.percentCharged = value;
				document.querySelector(".js-percentCharged").innerHTML = obj.battery.percentCharged;
			},
			chargingHours: (value) => {
				obj.battery.chargingHours = value + " Hours";
				window.your.battery.chargingHours = value;
				document.querySelector(".js-chargingHours").innerHTML = obj.battery.chargingHours;
			},
			dischargingHours: (value) => {
				obj.battery.dischargingHours = value + " Hours";
				window.your.battery.dischargingHours = value;
				document.querySelector(".js-dischargingHours").innerHTML = obj.battery.dischargingHours;
			},
		});
	};
	...
	<p>Now, you are in the country <strong title="country">${obj.country}</strong>, close to the city <strong title="city">${obj.city}</strong>, here in this <a href="${urlMapGoogle}">map</a> more or less.</p>
