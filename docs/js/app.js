...
const introduction = (data)=>{
	const scope = document.querySelector(".js-introduction");
	...
	let urlMap =  window.your.location.latitude ? `https://maps.google.com/maps?q=${window.your.location.latitude},${window.your.location.longitude}` : null;
	let obj = {
		...
		device: window.your.device.library.model || noSupport,
	...
	Now, you are in the country <strong title="country">${obj.country}</strong>, close to the city <strong title="city">${obj.city}</strong>, here in this <a href="${urlMap}">map</a> more or less.
	`;
